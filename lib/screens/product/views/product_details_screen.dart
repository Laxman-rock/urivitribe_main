...
import 'package:urvitribe_main/screens/product/views/product_returns_screen.dart';
...
class ProductDetailsScreen extends StatelessWidget {
  ...
  ProductDetailsScreen(
      {super.key, this.isProductAvailable = true, this.productDetails});
      ...
      body: SafeArea(
        child: CustomScrollView(
          slivers: [
            ...
            const ProductImages(images: [productDemoImg1]),
            ProductInfo(
              brand: "${productDetails?.productInfo?["subtitle"]}",
              title: "${productDetails?.brandName}",
